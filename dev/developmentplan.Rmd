...
* __tags.to.sectors()__: Take a list of tags and turn into a list of den objects. Option for mutually exclusive. [Coded, Quality Checked, Documented, Examples]
* __standard.sectors__: A list of tags with the standard sectors. [Coded, Quality Checked, Documented, Examples]  
...
* __ego.two.mode()__:
* __ego.network()__:
* __adj.ind()__: From den to adjacency matrix
...
* __level.of.power()__: Returns a categorical value for the level of power based on k-core decomposition.
